    ...
    return (
      <View style={styles.container}>
        <ImageBackground
          ...
          <ScrollView>
            <Text style={{ fontSize: 30 }}> Get a proper diet</Text>

            <Text style={styles.points}>
              1) Make most of your meal vegetables and fruits – ½ of your
              plate..
            </Text>
            ...
            <Text style={styles.points}>4) Drink water, coffee, or tea.</Text>

            <Text style={styles.points}>
              5) Choose and prepare foods with less salt and added sugars.{' '}
            </Text>
